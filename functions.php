...
<p>Hi, ' . trim(get_comment($parent_id)->comment_author) . '!<br> 你在文章 "' . get_the_title($comment->comment_post_ID) . '" 下的评论：</p>
...
<a target="_blank" style="color: #fff;background: #65c5ff;box-shadow: 0 5px 20px -10px #44b0f1;border: 1px solid #44b0f1;width: 200px;font-size: 14px;padding: 10px 0;border-radius: 2px;margin: 10% 0 5%;text-align:center;display: inline-block;text-decoration: none;" href="' . htmlspecialchars(get_comment_link($parent_id)) . '">查看</a>
</td>
</tr>
</tbody></table>
</td>
...
<p>© '.date("Y").' <a name="footer_copyright" href="' . home_url() . '" style="color: rgb(43, 136, 217); text-decoration: underline;" target="_blank">' . get_option("blogname") . '</a> / Powered by <a href="https://wordpress.org">WordPress</a> / Plugin by <a href="https://wpmailsmtp.com/">WP Mail SMTP</a> / Theme by <a href="https://biji.io/">Adams</a></p>
</td>
</tr>
</tbody>
</table>';
